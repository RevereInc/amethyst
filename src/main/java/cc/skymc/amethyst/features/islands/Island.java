...
public class Island {
  ...
  public final Document toBson() {
    ...
    document.append("x1", region.x1); document.append("x2", region.x2);
    document.append("y1", region.y1); document.append("y2", region.y2);
    document.append("z1", region.z1); document.append("z2", region.z2);
